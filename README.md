...
Crawl websites and track content changes over time with visual diffs using [Spider Cloud](https://spider.cloud) — the fastest web crawling infrastructure.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fspider-rs%2Fspider-diff-monitor&env=NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY)

**Live Demo:** [https://diff-monitor.spider.cloud](https://diff-monitor.spider.cloud)
...
```bash
git clone https://github.com/spider-rs/spider-diff-monitor.git
cd spider-diff-monitor
```
